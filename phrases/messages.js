module.exports = (ind, reference) => {
    ...
    if(ind.startsWith("math")) {
        messages.math = {
            ...
            "fail": `:exploding_head: Woops! Você acertou **${reference.acerts}** vezes. O seu recorde é de **${reference.record}** acertos, boa sorte na próxima.`,
            "timeout": `:clock1230: O tempo acabou! Você acertou **${reference.acerts}** vezes. O seu recorde é de **${reference.record}** acertos, boa sorte na próxima.`
        }
    } 
